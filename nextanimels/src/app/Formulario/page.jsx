                    ...
                    <div className="formulario align-items-center highlight-toolbar ps-3 pe-2 py-1">
                        ...
                        <div className="form-label">
                            ...
                            <textarea
                                name="sinopse"
                                value
                                placeholder="Digite a sinópse..."
                                defaultValue={""}
                            />
                        </div>
                        <p>Tipo</p>
                        <div className="d-flex tipo">
                            <input type="radio" name="tipo" id="ova" required />
                            ...
                            <input type="radio" name="tipo" id="tv" required />
                        ...
                        <div className="status d-flex">
                            ...
                            <input
                                ...
                                required
                            />
                            <label htmlFor="desenvolvimento">
                                Desenvolvimento
                            </label>
                        </div>
                        <input
                            type="submit"
                            defaultValue="Submeter"

...
export default function AnimePage({ params }) {
    ...
    const decodedTitle = animeTitle.replace(regex, (match, hex) => {
        return String.fromCharCode(parseInt(hex, 16));
    });
    const anime = decodedTitle.split("mal_id");

    const [animeData, setData] = useState([]);
    const loadData2 = async (animeId) => {
    ...
    useEffect(() => {
        ...
        const producersArray = animeData.producers?.map(
            (producer) => producer.name
        );
        const newAnimeProducers = producersArray?.join(", ");
        setAnimeProducers(newAnimeProducers);
        const licensorsArray = animeData.licensors?.map(
        ...
        const demographicsArray = animeData.demographics?.map(
            ...
            <div className="poster">
                ...
                <table id="infos">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <b>Episodes:</b> {animeData.episodes}
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <b>Broadcast:</b> {animeBroadcast}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Producers:</b> {animeProducers}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Licensors:</b> {animeLicensors}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Studios:</b> {animeStudios}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Source:</b> {animeData.source}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Genre:</b> {animeGenres}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Themes:</b> {animeThemes}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Demographic:</b> {animeDemographics}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Duration:</b> {animeData.duration}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Rating:</b> {animeData.rating}
                            </td>
                        </tr>
                    </tbody>
                </table>
